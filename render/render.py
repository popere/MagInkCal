...
class RenderHelper:
    ...
    def process_inputs(self, calDict):
        ...
        weatherText += '<div>' + emojize(':arrow_up:') + str(round(weather['daily'][0]['temp']['max'])) + '°C ' + emojize(':arrow_down:') + str(round(weather['daily'][0]['temp']['min'])) + '°C</div>\n'
        weatherText += '<div>' + emojize(':droplet:') + str(round(weather['daily'][0]['rain'])) + 'mm</div>\n'
